...
# red=which(Turnout_df$Ratio>1.12)
# lr=which(Turnout_df$Ratio>1 & Turnout_df$Ratio<1.12)
# lb=which(Turnout_df$Ratio<1 & Turnout_df$Ratio>0.89)
# blue=which(Turnout_df$Ratio<.89)
